...
<head>
    ...
    <meta name="author" content="Enterprise Maintenance">
...
<!-- logo prometi-->
                        <a class="navbar-Installation fables-logo-Installation pl-0" href="index.html" ><img src="prometimage\logonew1.png" alt="Fables Template" class="fables-logo"></a>
...
<div class="fables-header fables-after-overlay">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Projets en cours...</h2>
    </div>
</div>  
<!-- /End Header -->
...
<div class="container">
       <div class="row mt-3 mt-lg-5 mb-2">
           <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
               <div class="text-center">
                   <h2 class="fables-main-text-color font-35 bold-font my-3">Projets en cours</h2>
       ...
       <div class="gallery-filter">
            <div class="portfolioFilter mb-lg-5 clearfix">
              ...
              <a href="#" data-filter=".Construction" class="fables-forth-text-color">Construction</a>
              <a href="#" data-filter=".Aménagement" class="fables-forth-text-color">Aménagement</a>
              <a href="#" data-filter=".Installation" class="fables-forth-text-color">Installation</a>
              <a href="#" data-filter=".Maintenance" class="fables-forth-text-color">Maintenance</a>
            </div> 
        ...
        <div class="portfolioContainer mt-4 my-lg-5 row">
            ...
            @foreach ($projet as $pr )
               @if ($pr->typeprojet=='en cours') 
                <div class="{{$pr->catégorie}}  col-sm-6 col-md-5 mb-4">
                    <div class="filter-img-block position-relative image-container translate-effect-right">  
                         <img src="/images/{{$pr->image}}" alt="image"> 
